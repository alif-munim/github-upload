...
const client = contentful.createClient({
    ...
    accessToken: "d0e6mC6bYmvxRE4_WhWBe3WXdWA78qE9VwLJ7NoMuvY"
  });
...
class UI {
        ...
        products.forEach(product => {
            ...
            <!-- single product -->
                <article class="product">
                    <div class="img-container" style="background-image: url(${product.image})">
    ...
    addCartItem(item) {
        ...
        div.innerHTML = `
            <div class="thumbnail" style="background-image: url(${item.image})">
            </div>
            <div>
                <h4>${item.title}</h4>
                <h5>$${item.price}</h5>
    ...
    cartLogic() {
        ...
        cartContent.addEventListener("click", event => {
            ...
            if (event.target.classList.contains("remove-item")) {
                ...
                let id = subtractAmount.getAttribute("data-id");
                let tempItem = cart.find(item => item.id === id);
                tempItem.amount -= 1;
